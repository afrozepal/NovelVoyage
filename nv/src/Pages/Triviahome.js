...
function Triviapage(props) {
    ...
    useEffect(() => {
        const fetchTriviaData = async () => {
            try {
                const response = await axios.post('http://localhost:5000/generate-trivia', {
                    bookID,
    ...
    return (
        ...
        <div className="container-fluid display">
            <div className="row">
                {/* Main content */}
                <div className='col-md-9 triviad mx-auto cutom-trivia'>
                        ...
                        <div className="col">
                            <div className="card bg-dark text-white">
                                <div className="card-body">
                                    ...
                                    <Link to={`/trivia/66379ce55c06bf3deb2e3149`} className="btn btn-info" onClick={() => handleButtonClick('66379ce55c06bf3deb2e3149')}>Play Trivia</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col">
                            <div className="card bg-dark text-white">
                                <div className="card-body">
                                    ...
                                    <Link to={`/trivia/66379ce55c06bf3deb2e314c`} className="btn btn-info" onClick={() => handleButtonClick('66379ce55c06bf3deb2e314c')}>Play Trivia</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col">
                            <div className="card bg-dark text-white">
                                <div className="card-body">
                                    ...
                                    <Link to={`/trivia/66379ce55c06bf3deb2e314d`} className="btn btn-info" onClick={() => handleButtonClick('66379ce55c06bf3deb2e314d')}>Play Trivia</Link>
                                </div>
                            </div>
                        </div>
                        {/* Repeat for other books */}
                        ...
                        <div className="col">
                            <div className="card bg-dark text-white">
                                <div className="card-body">
                                    ...
                                    <Link to={`/trivia/66379ce55c06bf3deb2e314e`} className="btn btn-info" onClick={() => handleButtonClick('66379ce55c06bf3deb2e314e')}>Play Trivia</Link>
                                </div>
                            </div>
                        </div>
                        {/* Repeat for other books */}
                        ...
                        <div className="col">
                            <div className="card bg-dark text-white">
                                <div className="card-body">
                                    ...
                                    <Link to={`/trivia/66379ce55c06bf3deb2e3156`} className="btn btn-info" onClick={() => handleButtonClick('66379ce55c06bf3deb2e3156')}>Play Trivia</Link>
                                </div>
                            </div>
                        </div>
                        {/* Repeat for other books */}
